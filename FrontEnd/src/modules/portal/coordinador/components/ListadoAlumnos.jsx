...
export default function ListadoAlumnos({ users, totalUsers, onSelect, onClose, currentPage, pages, onPageChange, rowsPerPage, setRowsPerPage, selectedUserIds, setRoleFilter, roleFilter, onSearchChange, filtro, onClear }) {
  ...
  const renderCell = useCallback((user, columnKey) => {
    ...
    switch (columnKey) {
      ...
      case 'programa':
        return <span>{user.programa}</span>;
      case 'code':
    ...
    return (
      <div className='flex flex-col gap-4'>
        <div className='flex items-end justify-between gap-3'>
          ...
          <Button color='primary' isDisabled={!selectedUser} onPress={handleSeleccionUsuarios}>Agregar</Button>
        </div>
